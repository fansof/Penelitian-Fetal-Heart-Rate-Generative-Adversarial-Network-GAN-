...
def main():
    ...
    config = {
        ...
        'model_names': ['resnet1d'],  # <— run multiple models or set to 'all'
        'batch_size': 32,
        'learning_rate': 1e-3,
        'num_epochs': 100,
        'random_seed': 81,
        ...
        'synthetic_normal_limit': 0,
        'synthetic_abnormal_limit': 300,
        ...
        'output_dir': './results_kfold_cv_all_scenarios/ctgganph715_CNNREALONLY',

        # Which scenarios to run
        'run_scenarios': [1]  # add 3 if you want it too
    }
